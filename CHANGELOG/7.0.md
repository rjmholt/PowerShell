...
<li>fix 704 get-module test failure (Internal 13946)</li>
...
<li>Sign individual files in pkg (#13392)</li>
<li>Use authenticode cert for msix signing (#13330)</li>
<li>Sign the <code>MSIX</code> files for the store (#12582)</li>
<li>Use temp personal path at Runspace startup when env 'HOME' not defined (#13239)</li>
...
[7.0.4]: https://github.com/PowerShell/PowerShell/compare/...v7.0.4
